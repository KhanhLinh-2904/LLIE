...
if __name__ == '__main__':
    ...
    original_image_folder = '/home/user/low_light_enhancement/Zero-DCE++/data/Real'
    enhanced_image_folder = '/home/user/low_light_enhancement/Zero-DCE++/data/result_Test_Part2_onnx'
